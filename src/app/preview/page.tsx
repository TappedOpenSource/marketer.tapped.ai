          ...
          <div className="relative h-10 w-full min-w-[200px]">
            <form onSubmit={onSubmitHandler}>
              <div className="relative flex h-10 w-full min-w-[200px] max-w-[24rem]">
                <input
                  name="accessCode"
                  className="lowercase peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 pr-20 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                  placeholder=" "
                  required
                />
                <button
